...
public class RetoucherPerformance {
//these classes are  only Generators for users ... if you want this class to get a created user ... you need to put this class in package [Apis/gui] accordingly
     ...
     public static final String AdminRole = "is_retoucher_audited_user" ;

    public static AdminUsersPojo.UserData GenerateValidRetoucherPerformanceAdmin(){
    ...
    public static AdminUsersPojo.UserData GenerateInvalidRetoucherPerformanceAdmin(){
