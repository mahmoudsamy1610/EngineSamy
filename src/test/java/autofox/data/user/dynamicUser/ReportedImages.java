...
//these classes are  only Generators for users ... if you want this class to get a created user ... you need to put this class in package [Apis/gui] accordingly
     ...
     public static final String AdminRole = "is_reported_images_user" ;

    public static AdminUsersPojo.UserData GenerateValidReportedImagesAdmin(){
    ...
    public static AdminUsersPojo.UserData GenerateInvalidReportedImagesAdmin(){
